  ...
  return (
    <div>
      <div className="bg-black flex flex-col">
        ...
        <div className="text-white flex-grow text-base md:text-2xl lg:text-3xl space-y-6  text-justify leading-relaxed px-10 sm:px-20 py-10 lg:py-12 font-miso">
          ...
          <p>
            It's been 4 years and Bit Legion continues to foster
          ...
          <p>
            ...
            around the globe. Our last event, InfInITy 2k23, was a massive
            success, drawing over 127k+ submissions and 20k+ participants from
